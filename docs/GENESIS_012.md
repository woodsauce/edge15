# Genesis-012 — Commitment Engine

Genesis-012 introduces the contract-level Commitment Engine.

## Added

- Minute-3 Scout Mode / Commitment Mode.
- At roughly 12:00 remaining, Edge15 commits to OVER, commits to UNDER, or declares No Trade.
...
This fixes the confusing behavior where Edge15 could change its preferred side throughout the same 15-minute window. Genesis-012 separates:

- Opening evidence gathering.
- The minute-3 contract prediction.
